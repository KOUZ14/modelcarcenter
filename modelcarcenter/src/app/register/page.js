      ...
      <main className="flex-1 flex items-center justify-center p-4 py-8">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Join ModelCarCenter to start collecting
            </CardDescription>
          </CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    type="button"
                    onClick={() => setFormData({ ...formData, accountType: 'collector' })}
                    className={cn(
                      "flex flex-col items-center p-4 rounded-lg border-2 transition-colors",
                      formData.accountType === 'collector'
                  ...
                  >
                    ...
                    <span className="text-xs text-muted-foreground">Buy & collect</span>
                  </button>
                  <button
                    type="button"
                    onClick={() => setFormData({ ...formData, accountType: 'shop' })}
                    className={cn(
                      "flex flex-col items-center p-4 rounded-lg border-2 transition-colors",
                  ...
                  >
                    ...
                    <span className="text-xs text-muted-foreground">List & sell</span>
                  </button>
                </div>
              </div>
